...
<html lang="en" class="phone">
	<head>
		...
		<title>Localytics Ad Builder</title>
	...
	<body>
		<h1>
			<span><img class="logo" src="assets/img/hero.png" alt=""></span><span class="title">Localytics Ad Builder</span>
		</h1>
				...
				<div id="body_edit">
					...
					<div class="content_options bg_color">
						...
						<div data-format="rgba" class="cp8 input-group colorpicker-component">
							<input type="text" value="rgb(255, 255, 255)" class="form-control" />
